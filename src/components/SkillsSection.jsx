...
const skills = [
  ...
  { name: "Mapbox", level: 60, category: "frontend" },
  ...
  { name: "Rhino3D", level: 90, category: "tools" },
  { name: "Grasshopper", level: 85, category: "tools" },
  { name: "Unreal", level: 50, category: "tools" },
  { name: "Twinmotion", level: 60, category: "tools" },
  { name: "QGIS", level: 50, category: "tools" },
];
